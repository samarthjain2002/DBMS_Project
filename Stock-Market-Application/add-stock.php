...
if (isset($_POST) & !empty($_POST)) {
    ...
    if (empty($errors)) {
        ...
        curl_setopt_array($curl, array(
            CURLOPT_URL => "http://api.marketstack.com/v1/tickers?access_key=1e1529d33fecdc70f6199f094110ebbc&symbols=$symbol",
        ...
        if ($res) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY_ADJUSTED&symbol=$symbol&interval=5min&apikey=W74EZV4KUQ20A8YR&outputsize=full",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_FOLLOWLOCATION => true,
                CURLOPT_ENCODING => "",
                CURLOPT_MAXREDIRS => 10,
...
// include('cache-stock-values.php');
